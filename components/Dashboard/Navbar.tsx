...
import { AlarmClock, Home, Menu, SettingsIcon } from "lucide-react";
    ...
    <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
      <Sheet>
        ...
        <SheetContent side="left" className="flex flex-col">
          <nav className="grid gap-2 text-lg font-medium py-8"></nav>
        </SheetContent>
      </Sheet>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuLabel className="text-center font-extrabold uppercase">
            User Name
          </DropdownMenuLabel>
          <DropdownMenuSeparator />
